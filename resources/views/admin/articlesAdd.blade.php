                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="name">
                                        </div>
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="description">
                                        </div>
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="color">
                                        </div>
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="genre">
                                        </div>
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="brand">
                                        </div>
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="price">
                                        </div>
                                        ...
                                        <div class="col-span-8">
                                            ...
                                            <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" name="imgLink">
                                        </div>
                                    </div>
                                </div>
