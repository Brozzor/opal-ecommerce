<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <center>
      <a type="button" href="/admin/user/add" class=" mb-1 px-4 py-2 bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-900 focus:outline-none focus:shadow-outline-gray transition ease-in-out duration-150">
